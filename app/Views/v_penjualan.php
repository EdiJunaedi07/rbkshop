...
<head>
  ...
  <title>RBK-Shop | Penjualan</title>
...
<div class="wrapper">
          ...
          <div class="col-lg-7">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body bg-black color-palette text-right">
                <label class="display-4 text-green"><b>Rp. <?= number_format($grand_total, 0) ?>.-</b></label>
              </div>
            </div>
          </div>
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-3">
                        <button type="submit" class="btn btn-primary"><i class="fas fa-cart-plus"> Add</i></button>
                        <a href="<?= base_url('Penjualan/ResetCart') ?>" class="btn btn-warning"><i class="fas fa-sync"> Reset</i></a>
                        <a class="btn btn-success" data-toggle="modal" data-target="#pembayaran" onclick="Pembayaran()"><i class="fas fa-cash-register"> Pembayaran</i></a>
                    </div>
                    </div>
                    <?php echo form_close() ?>
                    </div>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <a href="<?= base_url('Penjualan/RemoveItemCart/'. $value['rowid']) ?>" class="btn btn-danger btn-sm"><i class="fas fa-times"></i></a>
                            </td>
                          </tr>
                          <?php } ?>
                        </tbody>
          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-body bg-black color-palette text-center">
                <h1 class="text-warning" id="terbilang"><b></b></h1>
              </div>
            </div>
          </div>
            <div class="col-12">
  ...
  <!-- /.control-sidebar -->
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2023 <a href="#">Rumah Beras Kenanga</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
...
<script>
    ...
    $.ajax({
      ...
      success: function (response) {
        if (response.nama_produk=='') {
          Swal.fire('Kode Produk Tidak Terdaftar Didatabase !!!');
        }else {
  ...
  function HitungKembalian() {
    ...
    let dibayar = parseFloat($('#dibayar').val().replace(/[^.\d]/g, ''));
