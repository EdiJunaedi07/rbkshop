<div class="col-md-12">
    <div class="card card-primary">
        <div class="card-header">
            ...
            <button type="button" onclick="NewWin=window.open('<?= base_url('Laporan/PrintDataProduk') ?>','NewWin','toolbar=no, width=1100,height=500,scrollbara=yes')" class="btn btn-tool"><i class="fas fa-print"></i> Print
                </button>
        ...
        <div class="card-body">
            ...
            if (!empty($errors)) { ?>
                <div class="alert alert-danger alert-dismissible">
                    <h5><i class="icon fas fa-ban"></i>Periksa Lagi Entry Form!</h5>
                    <ul>
                    ...
                    foreach ($produk as $key => $value) { ?>
                        <tr class="<?= $value['stok'] == 0 ? 'text-danger' : ''?>">
                            ...
                            <td class="text-center">
                                <a class="btn btn-warning btn-sm btn-flat" data-toggle="modal" data-target="#edit-data<?= $value['id_produk'] ?>"><i class="fas fa-pencil-alt"></i></a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="">Kode Produk</label>
                                <input name="kode_produk" type="text" class="form-control" value="<?= $value['kode_produk'] ?>" placeholder="Kode Produk" readonly>
                            </div>

                            <div class="form-group">
                                <label for="">Nama Produk</label>
                                <input  name="nama_produk" type="text" class="form-control" value="<?= $value['nama_produk'] ?>" placeholder="Nama Produk" required>
                            </div>
