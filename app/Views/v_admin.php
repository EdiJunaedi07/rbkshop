...
<div class="col-md-4">
    ...
    <div class="info-box mb-3 bg-primary">
        <span class="info-box-icon"><i class="fas fa-solid fa-money-bill-wave"></i></span>
...
<div class="col-md-4">
    ...
    <div class="info-box mb-3 bg-indigo">
        <span class="info-box-icon"><i class="fas fa-solid fa-file-invoice-dollar"></i></span>
...
<div class="col-md-4">
    ...
    <div class="info-box mb-3 bg-fuchsia">
        <span class="info-box-icon"><i class="fas fa-solid fa-money-check"></i></span>
